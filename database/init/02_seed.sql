...
INSERT INTO edps (id, norm_number, title, description, target, car_part, status, created_at, updated_at) VALUES
('edps-sample-001', '10101', 'Tire Change Procedure', 
 ...
 'Change tire safely and efficiently', 'WHEEL_ASSEMBLY', 'active', NOW(), NOW()),
...
('edps-sample-002', '10102', 'Engine Oil Change Standard',
 ...
 'Maintain engine lubrication system', 'ENGINE', 'active', NOW(), NOW()),
...
('edps-sample-003', '10103', 'Brake Inspection Protocol',
 ...
 'Ensure brake system safety', 'BRAKE_SYSTEM', 'active', NOW(), NOW());

-- Sample DVP (Design Validation Plan) records
INSERT INTO dvp (id, procedure_id, procedure_type, performance_objective, test_name, 
                 acceptance_criteria, responsible, parameter_range, car_part, status, created_at, updated_at) VALUES
('dvp-sample-001', '7.27', 'FUNCIONAL', 
 'Validate tire removal force requirements',
 'Tire Extraction Load Test',
 'Extraction force between 50N and 100N', 'Test Engineer', '0-150N', 'WHEEL_ASSEMBLY', 'active', NOW(), NOW()),
 
('dvp-sample-002', '7.28', 'DURABILIDADE',
 'Validate brake pad lifespan under normal conditions',
 'Brake Pad Wear Test',
 'Minimum 50,000km lifespan with <3mm wear', 'Quality Engineer', '0-100,000km', 'BRAKE_SYSTEM', 'active', NOW(), NOW()),
 
('dvp-sample-003', '7.29', 'AMBIENTAL',
 'Validate oil seal performance under temperature extremes',
 'Temperature Cycle Test',
 'No leakage between -40°C and 120°C', 'Thermal Engineer', '-40 to 150°C', 'ENGINE', 'active', NOW(), NOW());

-- Sample DFMEA (Design Failure Mode and Effects Analysis) records
INSERT INTO dfmea (id, generic_failure, failure_mode, cause, car_part,
                   prevention_control, detection_control,
                   severity, occurrence, detection, status, created_at, updated_at) VALUES
('dfmea-sample-001', 'Tire System', 'Difficult tire change', 'Damaged screw thread', 'WHEEL_ASSEMBLY',
...
('dfmea-sample-002', 'Brake System', 'Premature brake wear', 'Incorrect pad material selection', 'BRAKE_SYSTEM',
...
('dfmea-sample-003', 'Lubrication System', 'Oil leakage', 'Seal degradation at high temperature', 'ENGINE',
